...
@pytest.fixture()
def mock_generate_cute_creture_api(mocker):
    return mocker.patch(
...
async def test_create_post_with_prompt(
    async_client: AsyncClient, logged_in_token: str, mock_generate_cute_creture_api
):
    body = "Test Post"
    ...
    mock_generate_cute_creture_api.assert_called()
