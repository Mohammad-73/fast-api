...
async def generate_and_add_to_post(
    ...
    try:
        ...
        return await send_simple_email(
            ...
            f"Hi {email}! Unfortunately there was an error generating in image for your post.",
        )
    ...
    query = (
        ...
        .value(image_url=response["output_url"])
    )
    ...
    (
        await send_simple_email(
            ...
            f"Hi {email}! Your image has been generated and added to your post. Please click on the following link to view it: {post_url}",
        ),
    )
    return response
